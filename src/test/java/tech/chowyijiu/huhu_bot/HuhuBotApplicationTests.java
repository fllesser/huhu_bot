...
class HuhuBotApplicationTests {
    ...
    public void test1() {
        ...
        Event privateEvent = Event.respToEvent(JSONObject.parseObject(privateMessageJson, WsResp.class));
        System.out.println(privateEvent);
        Event groupEvent = Event.respToEvent(JSONObject.parseObject(groupMessageJson, WsResp.class));
